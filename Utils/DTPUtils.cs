...
namespace Klyte.DynamicTextProps.Utils
{
    internal class DTPUtils
    {
        ...
        {
            if (DynamicTextPropsMod.Controller.AbbreviationFiles.TryGetValue(DTPNetNodesData.Instance.CurrentDescriptor.NetNodeSettings.AbbreviationFile ?? "", out Dictionary<string, string> translations))
            {
