...
namespace Klyte.WriteTheSigns.UI
{
    ...
    internal class WTSPropPreviewRenderer : WTSPrefabPreviewRenderer<PropInfo>
    {
        ...
        protected override Matrix4x4 RenderMesh(PropInfo info, BoardTextDescriptorGeneralXml[] descriptor, Vector3 position, Quaternion rotation, Vector3 scale, Matrix4x4 sourceMatrix, out Color targetColor)
        {
            ...
            materialBlock.Clear();
            targetColor = WTSPropRenderingRules.GetColor(0, 0, 0, m_defaultInstance, null, out bool colorFound);
